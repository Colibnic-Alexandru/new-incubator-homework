...
const HW8 = () => {
    ...
    const sortUp = () => {
        setPeople(
            homeWorkReducer(initialPeople, {type: 'SORT_UP', payload: 'up'})
    ...
    const sortDown = () => {
        setPeople(
            homeWorkReducer(initialPeople, {type: 'SORT_DOWN', payload: 'down'})
    ...
    const check18 = () => {
        sortUp()
        setPeople(
            homeWorkReducer(initialPeople, {type: 'CHECK_AGE', payload: 18})
        ) // совершеннолетние
        setCurrentSort('18')
    }
